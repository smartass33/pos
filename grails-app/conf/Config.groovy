...
environments {
	...
	aws {
		...
		serverURL = "http://54.194.43.60"
		
		context=''
		log4j = {
				'null' name:'stacktrace'
				appenders {
					rollingFile name:'myAppender',file:"/var/log/tomcat7/pos.log", maxFileSize:1024000,maxBackupIndex:31,layout:pattern(conversionPattern: '%d %c{2} %m%n')
				}
