...
@Mock(PaymentMethod)
class PaymentMethodControllerSpec extends Specification {
    ...
    void "Test the index action returns the correct model"() {
        ...
        then:"The model is correct"
            !model.paymentMethodInstanceList
            model.paymentMethodInstanceCount == 0
    }
    ...
    void "Test the create action returns the correct model"() {
        ...
        then:"The model is correctly created"
            model.paymentMethodInstance!= null
    }
    ...
    void "Test that the show action returns the correct model"() {
        ...
        when:"A domain instance is passed to the show action"
            ...
            controller.show(paymentMethod)

        then:"A model is populated containing the domain instance"
            model.paymentMethodInstance == paymentMethod
    }
    ...
    void "Test the update action performs an update on a valid domain instance"() {
        ...
        when:"A valid domain instance is passed to the update action"
            response.reset()
            populateValidParams(params)
            paymentMethod = new PaymentMethod(params).save(flush: true)
            controller.update(paymentMethod)

        then:"A redirect is issues to the show action"
            response.redirectedUrl == "/paymentMethod/show/$paymentMethod.id"
            flash.message != null
    }
    ...
    void "Test that the delete action deletes an instance if it exists"() {
        ...
        when:"A domain instance is created"
            response.reset()
            populateValidParams(params)
            def paymentMethod = new PaymentMethod(params).save(flush: true)
